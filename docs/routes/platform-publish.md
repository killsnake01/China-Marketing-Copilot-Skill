...
| Codex 本机 | 同步到 `$CODEX_HOME/skills/china-marketing-copilot` | 同步后在安装目录运行 `scripts/validate_skill_pack.py` |
...
- 再运行 `python3 -B scripts/build_publish_package.py --platform all`。
